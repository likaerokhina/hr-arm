...
**2. Воронка**
- 2-pane layout: pipeline (scrollable kanban) · карточка кандидата справа
...
- Шапка: название, заказчик, мини-KPI (подобрано / на проверке / отправлено)
- Левая колонка: отправленные кандидаты + статусы (ждём / интервью / отказ) + кнопки «Интервью · Отказ · Переотправить»
- Правая колонка: лента событий (создание → подбор → проверка → DOCX → отправка → ответ)
- Закрывает Epic-1 US-1.3 и Epic-4 целиком
